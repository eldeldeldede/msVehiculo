                                   ...
                                   ModeloRepository modeloRepo){
                                    return args -> {
                                        ...
                                        if(marcaRepo.count() > 0){
                                            ...
                                            Vehiculo vehiculo1 = new Vehiculo(null, "AA-0000", modelo1, 0, "Negro", tipo2);
                                            Vehiculo vehiculo2 = new Vehiculo(null, "BB-0000", modelo2, 0, "Negro", tipo1);
                                            Vehiculo vehiculo3 = new Vehiculo(null, "CC-0000", modelo3, 0, "Negro", tipo1);
